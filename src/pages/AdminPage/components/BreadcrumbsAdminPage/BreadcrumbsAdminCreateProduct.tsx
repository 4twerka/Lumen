...
const BreadcrumbsAdminCreateProduct: React.FC = () => {
  return (
    <Breadcrumbs
    ...
    >
      ...
      <Link className={`${styles.link} ${styles.active}`} to="/admin/create-product">
      <BreadcrumbHome />
...
export default BreadcrumbsAdminCreateProduct;
